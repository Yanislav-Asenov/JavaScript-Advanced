...
// console.log(breakfastManager('restock carbohydrate 10'));
// console.log(breakfastManager('restock flavour 10'));
// console.log(breakfastManager('prepare apple 1'));
// console.log(breakfastManager('restock fat 10'));
// console.log(breakfastManager('prepare burger 1'));
// console.log(breakfastManager('report'));

// console.log(breakfastManager('prepare cheverme 1'));
// console.log(breakfastManager('restock protein 10'));
// console.log(breakfastManager('prepare cheverme 1'));
// console.log(breakfastManager('restock carbohydrate 10'));
// console.log(breakfastManager('prepare cheverme 1'));
// console.log(breakfastManager('restock fat 10'));
